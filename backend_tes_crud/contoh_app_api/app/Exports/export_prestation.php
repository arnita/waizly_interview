...
class export_prestation implements FromView, ShouldAutoSize, WithEvents
{
   ...
   use Exportable;
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class    => function(AfterSheet $event) use ($data_ex) {
                    ...
                    $event->sheet->getStyle('A4:H'.$data_ex)->applyFromArray([
                    'borders' => [
                        'allBorders' => [
	...
	public function view(): View
	{
        ...
        ->get();
		  ...
		  $data = ['data_siswa'=>$data_siswa,'walas'=>$walas,'category'=>$category];

		
		  return view('excel.export_prestation', [
           	 	'data' => $data]);		
	}	
}
