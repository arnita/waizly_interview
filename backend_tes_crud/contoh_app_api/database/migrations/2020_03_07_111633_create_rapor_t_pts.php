...
class CreateRaporTPts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       Schema::create('raport_pts', function (Blueprint $table) {
            $table->bigIncrements('raport_pts_id');
            ...
            $table->integer('raport_pts_insert_by')->nullable();
            $table->datetime('raport_pts_insert_time')->nullable();
            $table->datetime('raport_pts_update_time')->nullable();   
            $table->integer('raport_pts_update_by')->nullable();
            $table->datetime('raport_pts_delete_time')->nullable();   
            $table->integer('raport_pts_delete_by')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('raport_pts_pts');
    }
}
