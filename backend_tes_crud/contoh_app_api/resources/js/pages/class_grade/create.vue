        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"> <router-link to="/class_grade"> Tingkat Kelas </router-link>
                    </li>
                    <li class="breadcrumb-item"> Tambah Kelas
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Tambah Kelas</h5>
                </div>
        ...
        methods:{
            ...
            submit(e){
                ...
                return new Promise((resolve,reject)=>{
                    $axios.post(`/class_grade`,this.class_grade).then(function(resp){
