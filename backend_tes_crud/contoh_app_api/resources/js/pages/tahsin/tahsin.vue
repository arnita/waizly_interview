    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Input Nilai Tahsin</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> Input Nilai Tahsin
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="tahsin.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="tahsin.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="tahsin.study_group_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Tahsin</h5>
                        <div class="m-t-2">
    ...
    export default{
        ...
        methods:{
            ...
            get_data_setting(event){
                var app =this;
                $('#row_setting').show();
                  axios.get('get_study_group_setting?study_group_id='+app.tahsin.study_group_id)
                    .then(function(resp){
                    ...
                    axios.get('get_total_tahsin')
                    .then(function(resp){
                        console.log(resp);
                        app.data_tahsin = resp.data.data_tahsin; 
                        app.tahsin_type = resp.data.tahsin_type; 
                        axios.post('send_param_tahsin',{
                            params:{
                                    'data_show' : app.data_show,
                                    'data_tahsin' :app.data_tahsin,
                                    'tahsin_type' : resp.data.tahsin_type,
                                }
                            })
                        .then(function(resp){
            ...
            insert_tahsin(e,student_id,tahsin_type){
                axios.post('tahsin',{
                    'tahsin_value': e.target.value,
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('tahsin/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/tahsin_upload',formData,
                    {
