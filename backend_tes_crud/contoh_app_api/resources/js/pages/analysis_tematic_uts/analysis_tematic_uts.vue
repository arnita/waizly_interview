        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>  Input Analisis TEMA PTS </h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                        </li>
                        <li class="breadcrumb-item">  Input Analisis TEMA PTS
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="col-sm-12 table-responsive">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="analysis_tematic_uts.unit_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="analysis_tematic_uts.class_grade_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_tematik($event)" v-model="analysis_tematic_uts.study_group_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="structure_tematic_id" name="structure_tematic_id" @change="get_data_setting($event)" v-model="analysis_tematic_uts.structure_tematic_id">
...
<div class="row" style="display: none" id="row_setting">
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <h5 class="card-header-text"> Input Analisis Tema PTS</h5>
                    <div class="m-t-2">
							...
							<div class="col-sm-12">
								...
								<div v-for="dt,index in list_form">
									<div class="col-sm-2">
										...
										<input type="text" name="" @change="insert_analisis($event,student_id,index,dt.kd,'uts',dt.input_analysis_tema_id)" class="form-control" :value="dt.value">
									</div>
								</div>
							</div>
						</div>
...
export default{
    ...
    created(){
        ...
        this.get_study_group_all(this.analysis_tematic_uts.class_grade_id);  
    ...
    methods:{
     ...mapActions('application',['get_unit','get_class_grade','get_study_group','get_tematic_group','get_class_grade_all','get_study_group_all']),
            ...
            get_data_tematik(event){
                this.get_tematic_group(this.analysis_tematic_uts.class_grade_id).then(()=>{                    
                    this.list_tematic = this.tematic_group.data;
                });  
                this.get_data_setting(event);
            },
            ...
            async get_data_setting(e){
                ...
                await app.reload_table(app.analysis_tematic_uts.study_group_id,app.analysis_tematic_uts.structure_tematic_id);
                
            },
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('analysis_tematic_uts/export?study_group_id='+study_group_id+'&structure_tematic_id='+this.analysis_tematic_uts.structure_tematic_id);
            ...
            saveUpload(){
                ...
                $axios.post('/analysis_tematic_uts_upload',formData,
                {
			    ...
			    app.reload_table(app.analysis_tematic_uts.study_group_id,app.analysis_tematic_uts.structure_tematic_id); 
                app.close_modal();
		...
		reload_table(study_group_id,structure_tematic_id){
			...
			$axios.get('/load_data_tema?type=uts&study_group_id='+study_group_id+'&structure_tematic_id='+structure_tematic_id)
			.then(function(resp){
		...
		get_value(student_id){
			...
			$axios.get('/get_value_analisis_tema',{
				params: {
					...
					'structure_tematic_id' : app.analysis_tematic_uts.structure_tematic_id,
					'type':'uts',
				}
				})
				.then(function(resp){
	    ...
	    insert_analisis(e,student_id,question,kd_id,type,input_analysis_tema_id){
	        ...
	        $axios.post('/input_form_analisis_tema',{
	        	...
	        	'kd_id' : kd_id,
	        	'type':type,
                'structure_tematic_id': this.analysis_tematic_uts.structure_tematic_id,
