        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">Catatan Guru
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="teacher_note.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="teacher_note.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="teacher_note.study_group_id">
    ...
    <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> INPUT CATATAN GURU </h5>
                        <div class="m-t-2">
    ...
    export default{
        ...
        methods:{
            ...
            get_data_page(page){
                ...
                axios.get('study_group_setting?page='+page)
                .then(function(resp){
                    app.data_show = resp.data.data;
                    app.data_post = resp.data;
                    app.loading=false;  
            ...
            get_data_setting(event){
                ...
                $('#loading_show').show();
                var app =this;
                 axios.get('get_study_group_setting?study_group_id='+app.teacher_note.study_group_id)
                    .then(function(resp){
                        ...
                        axios.get('get_total_teacher_note')
                        .then(function(resp){
                            app.data_teacher_note = resp.data.data_teacher_note; 
                            app.category = resp.data.category; 
                            axios.post('send_param_teacher_note',{
                                params:{
                                        'data_show' : app.data_show,
                                        'data_teacher_note' :app.data_teacher_note,
            ...
            exportTableToExcel(table, name=''){
                ...
                var kd_id = $('#kd_id').val();
                window.open('teacher_note/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/teacher_note_upload',formData,
                    {
            ...
            get_value(student_id,teacher_note_type){
                var app =this;
                let input_teacher_note;
                const token = store.state.token
                 $.ajax({
                        url: '/api/get_value_teacher_note',
                        type:'GET',
                         headers:{
                        ...
                        data:{
                            ...
                            'teacher_note_type': teacher_note_type,
                        },
                        beforeSend(){
                            $('#loading_show').show();
                        },
                        success:function(resp){
                              return input_teacher_note = resp.data;
                        }
                    }).done(function(){
                        $('#loading_show').hide();
                    })
                 return input_teacher_note;
            }
