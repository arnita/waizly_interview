    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4>Penilaian Diri Sendiri</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item">Penilaian Diri Sendiri
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="pd.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="pd.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="pd.study_group_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Penilaian Diri Sendiri</h5>
                        <div class="m-t-2">
        ...
        methods:{
            ...
            get_data_setting(event){
                ...
                /* Ajax untuk get data siswa */
                 axios.get('get_study_group_setting?study_group_id='+app.pd.study_group_id)
                    .then(function(resp){
                        ...
                        axios.get('get_total_pd')
                        .then(function(resp){
                            app.data_pd = resp.data.data_pd; 
                            app.sosial = resp.data.sosial; 
                            app.spiritual = resp.data.spiritual; 
                            axios.post('send_param_pd',{
                                params:{
            ...
            insert_pd(ab,student_id,pd_type,pd_category){
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('pd/export?study_group_id='+study_group_id);
