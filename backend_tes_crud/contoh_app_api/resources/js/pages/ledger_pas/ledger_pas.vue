        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">  Ledger PAS </li>       
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="ledger_pas.unit_id">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="ledger_pas.class_grade_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input  Ledger PAS</h5>
                    </div>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="row,index in data_show">
                                        ...
                                        <td>
                                            <button class="btn btn-primary" type="button" @click="download_ledger(row.study_group_id)"> Download Ledger
                                            </button>
                                            <router-link :to="{name:'ledger_pas.print_ledger',params:{id:row.study_group_id,class_grade_id:row.class_grade_id}}" class="btn btn-success"> Lihat Ledger </router-link>       
                                        </td>
                                    </tr>
                                </tbody>
...
import store from '../../store.js'
    ...
    export default{
        ...
        methods:{
            ...
            async download_ledger(id){
                $('#loading_show').show();
                var app =this;
                 await axios.get('insert_raport?study_group_id='+id+'&class_grade_id='+app.ledger_pas.class_grade_id)
                .then(function(resp){
                    $('#loading_show').hide();
                    window.location ='download_ledger/export?study_group_id='+id+'&class_grade_id='+app.ledger_pas.class_grade_id;    
