        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">Raport PAS Siswa
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" name="unit_id" v-model="raport_pas.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="raport_pas.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="raport_pas.study_group_id">
                        ...
                        <div class="col-sm-12 table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><input type="checkbox" class="form-check-input" name="course_id"> All </th>
                                        <th>NISN </th>
                                        <th> Nama Siswa</th>
                                        <th> Jenis Kelamin</th>
                                        <th> Action </th>
                                ...
                                <tbody>
                                    <tr v-for="row,index in data_show">
                                        ...
                                        <td>{{index+1}}</td>
                                        <td><input type="checkbox" class="form-check-input" name="course_id"></td>
                                        ...
                                        <td> 
                                            ...
                                            <router-link :to="{name:'raport_pas.print_pas',query:{id:row.student_id,name:row.student_name,study_group_id:raport_pas.study_group_id,class_grade_id:raport_pas.class_grade_id}}" class="btn btn-success"> Lihat Raport </router-link>
...
import loading from '../../components/loading.vue';
    ...
    export default{
        ...
        created(){
            ...
            this.get_study_group_all_(this.raport_pas.class_grade_id);  
        ...
        methods:{
            ...
            get_study_group_all_(e){
                this.get_study_group_all(this.raport_pas.class_grade_id).then(()=>{                    
                    this.get_data_page();
                });                
            },
            ...
            search_raport_pas(page){
                ...
                /* Ajax untuk get data siswa */
                axios.get('study_group_setting?study_group_id='+app.raport_pas.study_group_id+'&q='+app.search)
                .then(function(resp){
                    app.data_show = resp.data.data;
                    app.data_post = resp.data;
                    app.loading=false;  
            ...
            downloadWithCSS(id,name) {                    
                var app = this;
                window.open('raport/print_raport?id='+ id +'&study_group_id='+app.raport_pas.study_group_id+'&class_grade_id='+app.raport_pas.class_grade_id);
            }
