        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">Prestasi
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="prestation.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="prestation.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="prestation.study_group_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Prestasi</h5>
                        <div class="m-t-2">
        ...
        methods:{
            ...
            get_data_setting(event){
                ...
                var app =this;
                 ...
                 axios.get('get_study_group_setting?study_group_id='+app.prestation.study_group_id)
                    .then(function(resp){
                        app.data_show = resp.data;
                        app.data_post = resp.data;
                        app.loading=false;  

                        axios.get('get_total_prestation')
                        .then(function(resp){
                            app.data_prestation = resp.data.data_prestation; 
                            app.category = resp.data.category; 
                            axios.post('send_param_prestation',{
                                params:{
                                        'data_show' : app.data_show,
                                        'data_prestation' :app.data_prestation,
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('prestation/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/prestation_upload',formData,
                    {
