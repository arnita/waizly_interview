    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Setting Soal PTS  {{tematic_active.structure_tematic_name}} </h4>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Setting Soal PTS  {{tematic_active.structure_tematic_name}} </h5>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="row,index in data_show">
                                        ...
                                        <td>{{row.kd_name}}</td>
                                        <td>{{row.kd_type}}</td>
                                         <td>{{row.question_uts}}</td>
                                       <!-- 
                                        <td>{{row.question_uts}}</td>
                                        <td>{{row.question_uas}}</td>
                                        <td>
                                            <router-link class="btn btn-primary" :to="{name:'structure_tematic.create_question_uts',params:{id:row.kd_id}}" >PTS</router-link>
                                        </td>
                                        <td>
                                            <router-link class="btn btn-primary" :to="{name:'structure_tematic.create_question_uts',params:{id:row.kd_id}}" >PTS</router-link>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <router-link class="btn btn-primary" :to="{name:'structure_tematic.create_question_uts',params:{id:row.kd_id,st_id:row.structure_tematic_id}}" >Buat Soal</router-link>
                                        </td>
                                    </tr>
                                </tbody>
        ...
        methods:{
            ...
            {	
                ...
                .then(function(resp){
                    ...
                    app.structure_tematic_detail.question_all= resp.data.data.data.question_uts;	
            ...
            delete_detail(id){
                swal({
                    ...
                    if(willdelete){
                        var app = this;
                        axios.delete('structure_tematic_detail/'+id+'?type_question=uts')
                        .then(function(resp){
            ...
            get_kd_(e){
                axios.get('get_data_kd_course?course_id='+e.target.value+'&type=per_kd&class_grade_id='+this.class_grade_id+'&type_question=uts'+'&type_tema=tematic')
