    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Buat Soal Daily Test Tematik </h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">  Buat Soal Tematik
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text"> Buat Soal Daily Test Tematik </h5>
                </div>
...
<script>
    ...
    export default{
        ...
        created(){
            this.get_daily_tema(this.id).then((resp)=>{
        ...
        computed:{
            ...mapState('application', {
                daily_tema:state=>state.daily_tema,
            }),
        },
       
        methods:{
            ...mapActions('application',['get_daily_tema']),
            insert_number(e,id,kd_id){
                $axios.post(`/insert_number`,{'number_question':e.target.value,'id':id,'kd_id':kd_id,'structure_tematic_id':this.structure_tematic_id})
                    .then(function(resp){
            ...
            insert_quality(e,id,kd_id){
                $axios.post(`/insert_quality`,{'quality_question':e.target.value,'id':id,'kd_id':kd_id})
                    .then(function(resp){
                        // swal('Success','Simpan data berhasil','success');
                })   
            },
            async cek_number(){
                ...
                await $axios.get('/cek_number?type_question=daily&id='+app.id+'&structure_tematic_id='+app.structure_tematic_id)
                .then(function(resp){
