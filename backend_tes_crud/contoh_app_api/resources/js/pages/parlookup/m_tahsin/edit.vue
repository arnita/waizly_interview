        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"> <router-link to="/m_tahsin"> Tahsin </router-link>
                    </li>
                    <li class="breadcrumb-item"> Ubah Tahsin
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Ubah Tahsin</h5>
                </div>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            ...
                            <form id="form-class-grade" @submit="update_parlookup_tahsin">
                                <div class="form-group row" :class="{'has-danger':errors.name}">
                                    <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Nama Tahsin <span class="form-mandatory">*</span> </label>
                                    <div class="col-sm-10">
                                        <input class="form-control " name="name" type="text" value=""  v-model="parlookup_tahsin.name">
                                        <input class="form-control " name="parlookup_id" type="hidden" value=""  v-model="parlookup_tahsin.parlookup_id">
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            .then(function(resp){
                app.isLoading = false;
                app.parlookup_tahsin.name = resp.data.name;
                app.parlookup_tahsin.desc = resp.data.desc;
                app.parlookup_tahsin.parlookup_tahsin_status = resp.data.parlookup_tahsin_status;
                app.parlookup_tahsin.parlookup_id = resp.data.parlookup_id;
                app.parlookup_tahsin.unit_id = resp.data.unit_id;
        ...
        methods:{
            ...
            clear_form(){
                ...
                this.parlookup_tahsin.parlookup_tahsin_status='';
                this.parlookup_tahsin.unit_id='';
                this.errors=[];
            },
            onCancel() {
            },
            update_parlookup_tahsin(e){
                e.preventDefault();
                var app = this;
                return new Promise((resolve,reject)=>{
                    $axios.put('/update_parlookup/'+this.parlookup_tahsin.parlookup_id,this.parlookup_tahsin).then(function(resp){
