        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"> <router-link to="/parlookup_extracurricular"> Ekstrakurikuler </router-link>
                    </li>
                    <li class="breadcrumb-item"> Ubah Ekstrakurikuler
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Ubah Ekstrakurikuler</h5>
                </div>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            ...
                            <form id="form-class-grade" @submit="update_parlookup_extracurricular">
                                <div class="form-group row" :class="{'has-danger':errors.name}">
                                    <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Nama Ekstrakurikuler <span class="form-mandatory">*</span> </label>
                                    <div class="col-sm-10">
                                        <input class="form-control " name="name" type="text" value=""  v-model="parlookup_extracurricular.name">
                                        <input class="form-control " name="parlookup_id" type="hidden" value=""  v-model="parlookup_extracurricular.parlookup_id">
    ...
    export default{
        ...
        return {
            ...
            parlookup_extracurricular:{
                name:'',
                desc:'',
                parlookup_extracurricular_status:'',
                parlookup_id:'',
                unit_id:'',
        ...
        mounted(){
            ...
            .then(function(resp){
                app.isLoading = false;
                app.parlookup_extracurricular.name = resp.data.name;
                app.parlookup_extracurricular.desc = resp.data.desc;
                app.parlookup_extracurricular.parlookup_extracurricular_status = resp.data.parlookup_extracurricular_status;
                app.parlookup_extracurricular.parlookup_id = resp.data.parlookup_id;
                app.parlookup_extracurricular.unit_id = resp.data.unit_id;
        ...
        methods:{
            ...
            clear_form(){
                ...
                this.parlookup_extracurricular.parlookup_extracurricular_status='';
                this.parlookup_extracurricular.unit_id='';
                this.errors=[];
            },
            onCancel() {
            },
            update_parlookup_extracurricular(e){
                e.preventDefault();
                var app = this;
                return new Promise((resolve,reject)=>{
                    $axios.put('/update_parlookup/'+this.parlookup_extracurricular.parlookup_id,this.parlookup_extracurricular).then(function(resp){
