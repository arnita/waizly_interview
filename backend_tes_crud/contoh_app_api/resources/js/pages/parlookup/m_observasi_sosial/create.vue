    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4>Tambah Input Sosial</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> <router-link to="/m_sosial">  Input Sosial </router-link>
                    </li>
                    <li class="breadcrumb-item"> Tambah Input Sosial
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Tambah Input Sosial</h5>
                </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <form id="form-class-grade" @submit="submit">
                                <div class="form-group row" :class="{'has-danger':errors.name}">
                                    <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Nama Input Sosial <span class="form-mandatory">*</span> </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row" :class="{'has-danger':errors.desc}">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-control-feedback" v-if="errors.desc">{{errors.parlookup_sosial_desc[0]}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <center>
                                            ...
                                            <router-link to="/m_sosial" class="btn btn-default m-r-30">Batal</router-link>
                                        </center>
                                    </div>
                                </div>
                            </form>
        ...
        methods:{
            ...
            submit(e){
                ...
                return new Promise((resolve,reject)=>{
                    $axios.post(`/store_parlookup`,this.parlookup_sosial).then(function(resp){
