        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"> Fisik
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="physical_student.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="physical_student.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="physical_student.study_group_id">
   ...
   <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Fisik</h5>
                        <div class="m-t-2">
    ...
    export default{
        data:function(){
            return {
                ...
                fisik:'',
                search:'',
                looping_physical :['Fisik','Kesehatan'],
                showModal: false,
                physical_student:{
                    unit_id:'',
                    class_grade_id:'',
        ...
        methods:{
            ...
            get_data_setting(event){
                ...
                var app =this;
                $('#row_setting').show();
                  axios.get('get_study_group_setting?study_group_id='+app.physical_student.study_group_id)
                    .then(function(resp){
                        ...
                        axios.get('get_list_question_n_total_physical_stu')
                        .then(function(resp){
                            app.data_physical = resp.data.data_physical; 
                            app.kesehatan = resp.data.kesehatan; 
                            app.fisik = resp.data.fisik; 
                            axios.post('send_param_physical_student',{
                                params:{
                                        'data_show' : app.data_show,
                                        'data_physical' :app.data_physical,
                                        'fisik' : resp.data.fisik,
                                        'kesehatan' : resp.data.kesehatan,
                                    }
                                })
                            .then(function(resp){
            ...
            insert_fs(e,student_id,physical_type,physical_category){
                axios.post('physical_student',{
                    'physical_value': e.target.value,
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('input_physic/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/physical_student_upload',formData,
                    {
