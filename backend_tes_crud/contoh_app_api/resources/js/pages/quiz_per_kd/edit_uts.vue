        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"> <router-link to="/quiz_uts"> Soal PAS </router-link>
                    </li>
                    <li class="breadcrumb-item">  Edit Soal PAS
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text"> Edit Soal PAS</h5>
                </div>
        ...
        mounted(){  
            ...
            .then(function(resp){
                ...
                app.get_data_kd_course_new({course_id: resp.data.data.course_id,class_grade_id:resp.data.data.class_grade_id}).then(()=>{
                 ...
                 app.get_course_study_group(resp.data.data.study_group_id).then(()=>{                    
