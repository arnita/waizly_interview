    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Edit Soal Ulangan Daily Test</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> <router-link to="/quiz_per_kd"> Soal Ulangan Daily Test </router-link>
                    </li>
                    <li class="breadcrumb-item">  Edit Soal Ulangan Daily Test
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text"> Edit Soal Ulangan Daily Test</h5>
                </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            ...
                            <form id="form-class-grade" @submit="submit">
                                <div class="form-group row" :class="{'has-danger':errors.class_grade_id}">
                                    ...
                                    <div class="col-sm-10">
                                        <select disabled class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="quiz_per_kd.class_grade_id">
...
<!-- 
 ...
 -->
                                ...
                                <div class="form-group row" :class="{'has-danger':errors.course_id}">
                                    ...
                                    <div class="col-sm-10">
                                        <select disabled class="form-control" id="course_id" @change="get_kd_($event)" name="course_id" v-model="quiz_per_kd.course_id">
                                ...
                                <div class="form-group row" :class="{'has-danger':errors.kd_id}">
                                    ...
                                    <div class="col-sm-10">
                                        <select disabled class="form-control" id="kd_id"  name="kd_id" v-model="quiz_per_kd.kd_id">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <center>
                                            <button type="submit" class="btn btn-primary m-r-30" id="btn-update">Simpan</button>
    ...
    export default{
        ...
        computed:{
            ...mapState('application', {
                ...
                data_kd_course_new:state=>state.data_kd_course_new,
                class_grade:state=>state.class_grade,
        ...
        mounted(){  
            ...
            $axios.get('/quiz_per_kd/'+id+'/edit')
            .then(function(resp){
                app.isLoading = true;
                console.log(resp.data.data.course_id);
                app.get_study_group(resp.data.data.class_grade_id).then(()=>{                    
                    app.list_study_group = app.study_group;
                }); 

                app.get_data_kd_course_new({course_id: resp.data.data.course_id,class_grade_id:resp.data.data.class_grade_id}).then(()=>{
                    app.list_kd = app.data_kd_course_new;
                });                  
                                    // this.get_employee_setting({course_id : $('#course_id').val(),employee_id:0 }).then(()=>{
                 app.get_course_study_group(resp.data.data.class_grade_id).then(()=>{                    
                    app.list_course_ = app.course_study_group;
                });  
                 app.isLoading = false;
                app.quiz_per_kd.quiz_per_kd_id = resp.data.data.quiz_per_kd_id;
                app.quiz_per_kd.course_id = resp.data.data.course_id;
                app.quiz_per_kd.total_question = resp.data.data.total_question;
                app.quiz_per_kd.description = resp.data.data.description;     
                app.quiz_per_kd.class_grade_id = resp.data.data.class_grade_id;     
                app.quiz_per_kd.study_group_id = resp.data.data.study_group_id;     
                app.quiz_per_kd.kd_id = resp.data.data.kd_id;
        ...
        methods:{
            ...
            ...mapActions('application',['get_unit','get_data_kd_course','get_class_grade_all','get_course_study_group','get_study_group','get_data_kd_course_new']),
            clear_form(){
            ...
            submit(e){
                ...
                return new Promise((resolve,reject)=>{
                    $axios.put('/quiz_per_kd/'+app.quiz_per_kd.quiz_per_kd_id,app.quiz_per_kd).then(function(resp){
