    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Tambah Soal Ulangan PTS</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> <router-link to="/quiz_uts"> Soal Ulangan PTS </router-link>
                    </li>
                    <li class="breadcrumb-item">  Tambah Soal Ulangan PTS
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text"> Tambah Soal Ulangan PTS</h5>
                </div>
    ...
    export default{
        ...
        methods:{
            ...
            get_kd_(e){
                ...
                var app = this;
                $axios.get('/get_data_kd_course?course_id='+e.target.value+'&type=per_kd&class_grade_id='+app.quiz_per_kd.class_grade_id+'&type_question=uts')
                .then(function(resp){
