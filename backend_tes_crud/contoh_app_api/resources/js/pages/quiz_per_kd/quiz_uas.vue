    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Soal Ulangan PAS </h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> Soal Ulangan PAS 
                    </li>    
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text">  Soal Ulangan PAS  </h5>
                    </div>
                    ...
                    <router-link :to="{name:'quiz_uas.create_uas'}" class="btn btn-primary pull-left txt-white m-t-2"> Tambah </router-link>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="row,index in data_show">
                                        ...
                                        <td>
                                            <router-link class="btn btn-warning"   v-if="role_name == 'Admin' " :to="{name:'quiz_uas.edit_uas',params:{id:row.quiz_per_kd_id}}" ><i class="fa fa-pencil"></i>
                                            </router-link>
                                             ...
                                             <router-link class="btn btn-primary" :to="{name:'quiz_uas.create_question_uas',params:{id:row.quiz_per_kd_id,course_id:row.course_id}}" > Buat Soal
                                            </router-link>
                                        </td>
                                    </tr>
                                </tbody>
