            ...
            <div class="card">
               ...
               <loading :active.sync="isLoading" 
                                    ...
                                    <div class="col-sm-12 table-responsive">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row" :class="{'has-danger':errors.username}">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control " name="username" placeholder='Terisi Otomatis Disaat di buat' readonly type="text" value=""  v-model="employee.username">
                                            ...
                                            <div class="form-group row" :class="{'has-danger':errors.password}">
                                                ...
                                                <div class="col-sm-8">
                                                    <button class="btn btn-primary" @click="ubah_password()" > Ubah Password </button>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr v-for="row,index in employee.employee_unit">
                                                                <td>
                                                                    {{row.unit_name}}
                                                                </td>
                                                                <td>
                                                                    <button class="btn btn-danger" @click="delete_employee_unit(row.employee_unit_id)"><i class="fa fa-minus"></i> </button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row" :class="{'has-danger':errors.employee_status}">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="employee_status" id="" class="form-control" v-model="employee.employee_status">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <center>
                            <button type="submit" class="btn btn-primary m-r-30" @click="update_employee" :disabled='isDis'>Simpan</button>
    ...
    export default{
        ...
        mounted(){
            ...
            .then(function(resp){
                ...
                /* For User */
                app.employee.username = resp.data.data.user.username;


                app.employee.employee_id=resp.data.data.employee.employee_id;
                app.employee.employee_birth_date=resp.data.data.tanggal_lahir;
                app.employee.employee_status=resp.data.data.employee.employee_status;
                app.employee.employee_id_card=resp.data.data.employee.employee_id_card;
                app.employee.position_id=resp.data.data.employee.position_id;
                app.employee.employee_type=resp.data.data.employee.employee_type;
                app.employee.employee_name=resp.data.data.employee.employee_name;
                app.employee.employee_working_status=resp.data.data.employee.employee_working_status;
                app.employee.employee_nik=resp.data.data.employee.employee_nik;
                app.employee.employee_gender=resp.data.data.employee.employee_gender;
                app.employee.employee_birth_place=resp.data.data.employee.employee_birth_place;
                app.employee.employee_religion=resp.data.data.employee.employee_religion;
                app.employee.employee_identity=resp.data.data.employee.employee_identity;
                app.employee.employee_last_education=resp.data.data.employee.employee_last_education;
                app.employee.employee_marital_status=resp.data.data.employee.employee_marital_status;
                app.employee.employee_hp=resp.data.data.employee.employee_hp;
                app.employee.employee_website=resp.data.data.employee.employee_website;
                app.employee.employee_telp=resp.data.data.employee.employee_telp;
                app.employee.employee_address=resp.data.data.employee.employee_address;
                app.employee.photo_assign=resp.data.data.employee.photo_assign;
                app.employee.employee_desc=resp.data.data.employee.employee_desc;
                app.employee.employee_email=resp.data.data.employee.employee_email;
                app.employee.employee_role = resp.data.data.employee.employee_role;
                app.employee.user_id = resp.data.data.employee.user_id;

                $axios.get('/get_employee_unit?employee_id='+app.employee.employee_id)
                .then(function(resp){
                    
                    for(var unit in resp.data){
                        app.employee.employee_unit.push(resp.data[unit]);
                    }
                })
        ...
        methods:{
            ...
            select_one(unit_id,employee_id)
            {
                alert(unit_id)
                // $('#modal').modal('hide');
                 $axios.post('edit_employee_unit/',{'unit_id':unit_id,'employee_id':employee_id})
                    .then(function(resp){
     ...
     /* =============== For Function Image Handler =========================== */
            ...
            update_employee(e){
                ...
                return new Promise((resolve,reject)=>{
                    $axios.put('/employee/'+this.employee.employee_id,app.employee).then(function(resp){
