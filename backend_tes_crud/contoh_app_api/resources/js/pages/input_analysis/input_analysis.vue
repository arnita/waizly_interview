        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4> Input Analisis Harian </h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">

                        <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                        </li>
                        <li class="breadcrumb-item">  Input Analisis Harian
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="col-sm-12 table-responsive">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="unit_id" name="unit_id" v-model="input_analysis.unit_id">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="class_grade_id"  name="class_grade_id" @change="get_study_group_($event)" v-model="input_analysis.class_grade_id">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="course_id" name="course_id" @change="get_data_kd_course_($event)" v-model="input_analysis.course_id">
                                            <option value=""> - Pilih Mata Pelajaran - </option>
                                            <option  v-for="(item, index) in list_course_.data " :key="index" :value="item.course_id"> {{item.course_name}} </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="form-control-label"> Pilih Kompetensi Dasar  </label>
                                        <select class="form-control" id="kd_id" name="kd_id" @change="get_data_setting($event)" v-model="input_analysis.kd_id">
        ...
        <div class="row" style="" v-if="div_seen" >
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h5 class="card-header-text"> Input Analisis Harian</h5>
                            <div class="m-t-2">
                                ...
                                <table ref="table" id="loremTable" summary="Input analisis" class="table table-bordered m-t-2">
									...
									<tbody>
										<tr v-for="row,index in data_show">
											<td>{{index+1}}</td>
											<td>
                                                <!-- <button class="btn btn-success" @click="tambah(row.student_name,row.student_id)" title ="tambah"> <i class="fa fa-plus"></i> </button> -->
                                            </td>
                                            ...
                                            <td>
                                             ...
                                             <!-- $dd->tot*100/$request->params['total_bobot']); -->
							...
							<div class="col-sm-12">
								...
								<div v-for="dt,index in list_form">
									<div class="col-sm-2">
										...
										<input type="text" name="" @change="insert_analisis($event,student_id,index,dt.kd,'daily',dt.input_analysis_id)" class="form-control" :value="dt.value">
									</div>
								</div>
							</div>
						</div>
...
export default{
    ...
    methods:{
        ...
        get_course_(e){
            ...
            $axios.get('/get_course_per_kd?study_group_id='+e+'&class_grade_id='+this.input_analysis.class_grade_id+'&type_kd=non_tema&type_question=daily')
            .then(function(resp){
                app.list_course_ = resp.data;
                $('#loading_show').hide();
                app.get_data_setting();
            }).catch(function(resp){

            })   
        },
        get_data_kd_course_(e){
            var app = this;
            if(typeof e == 'undefined')
            {
                e = app.input_analysis.course_id  
            }
            else
            {
                e = e.target.value
            }
            $axios.get('/get_data_kd_course?course_id='+e+'&type=per_kd&class_grade_id='+app.input_analysis.class_grade_id)
            .then(function(resp){
        ...
        async get_data_setting(e){
            ...
            var app =this;
            app.div_seen= true;
            app.input_analysis.kd_id = app.input_analysis.kd_id;

            await app.reload_table(app.input_analysis.study_group_id,app.input_analysis.class_grade_id,app.input_analysis.course_id,app.input_analysis.kd_id);
        ...
        onlyNumber ($event) {
         let keyCode = ($event.keyCode ? $event.keyCode : $event.which);
          ...
          exportTableToExcel(table, name=''){
            ...
            var kd_id = $('#kd_id').val();
            window.open('input_analysis/export?study_group_id='+study_group_id+'&kd_id='+kd_id+'&type_question='+app.input_analysis.type_question+'&class_grade_id='+app.input_analysis.class_grade_id);
        ...
        saveUpload(){
            ...
            $axios.post('/input_analysis',formData,
            {
            ...
            .then(function(resp){
                ...
                app.reload_table(app.input_analysis.study_group_id,app.input_analysis.class_grade_id,app.input_analysis.course_id,app.input_analysis.kd_id);
                    app.close_modal();
                    app.loading=false;  
		...
		reload_table(study_group_id,class_grade_id,course_id,kd_id){
			var app = this;
			$('#loading_show').show();

			$axios.get('/load_data?type=daily&study_group_id='+study_group_id+'&class_grade_id='+class_grade_id+'&course_id='+course_id+'&kd_id='+kd_id)
			.then(function(resp){
		 ...
		 get_value(student_id){
			...
			$axios.get('/get_value_analisis',{
				params: {
					...
					'kd_id' : app.input_analysis.kd_id,
					'type':'daily',
				}
				})
				.then(function(resp){
