		...
		<div class="row">
			<div class="col-sm-12 p-0">
				<div class="main-header">
					<h4> Input Analisis PTS </h4>
					<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">

						<li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
						</li>
						<li class="breadcrumb-item">  Input Analisis PTS
						</li>
					</ol>
				</div>
			</div>
        ...
        <div class="row" style="" v-if="div_seen" >
			<div class="col-sm-12">
				...
				<div class="card">
					<div class="card-header">
						<div>
							<h5 class="card-header-text"> Input Analisis PTS</h5>
							<div class="m-t-2">
							...
							<div class="col-sm-12">
								...
								<div v-for="dt,index in list_form">
									<div class="col-sm-2">
										...
										<input type="text" name="" @change="insert_analisis($event,student_id,index,dt.kd,'uts',dt.input_analysis_id)" class="form-control" :value="dt.value">
									</div>
								</div>
							</div>
						</div>
...
export default{
	...
	methods:{
		...
		get_course_(e){
            ...
            $axios.get('/get_course_per_kd?study_group_id='+e+'&class_grade_id='+this.input_analysis.class_grade_id+'&type_kd=non_tema&type_question=uts')
			.then(function(resp){
	...
	onlyNumber ($event) {
		...
		exportTableToExcel(table, name=''){
			...
			window.open('input_analysis_uts/export?course_id='+app.input_analysis.course_id+'&study_group_id='+study_group_id+'&type_question='+app.input_analysis.type_question+'&class_grade_id='+app.input_analysis.class_grade_id);
		...
		saveUpload(){
			...
			$axios.post('/input_analysis_kd_uts',formData,
			{
		...
		reload_table(study_group_id,class_grade_id,course_id){
			...
			$axios.get('/load_data?type=uts&study_group_id='+study_group_id+'&class_grade_id='+class_grade_id+'&course_id='+course_id)
			.then(function(resp){
	    ...
	    insert_analisis(e,student_id,question,kd_id,type,input_analysis_id){
			// console.log(input_analysis_id);debugger;
