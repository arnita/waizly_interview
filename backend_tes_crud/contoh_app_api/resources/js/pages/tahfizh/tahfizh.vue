    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4> Input Nilai Tahfizh</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> Input Nilai Tahfizh
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="tahfizh.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="tahfizh.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="tahfizh.study_group_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Tahfidz</h5>
                        <div class="m-t-2">
    ...
    export default{
        ...
        methods:{
            ...
            get_data_setting(event){
                $('#row_setting').show();
                var app = this;
                 axios.get('get_study_group_setting?study_group_id='+app.tahfizh.study_group_id)
                    .then(function(resp){
                    ...
                    axios.get('get_total_tahfizh')
                    .then(function(resp){
                        app.data_tahfizh = resp.data.data_tahfizh; 
                        app.tahfizh_type = resp.data.tahfizh_type; 
                        axios.post('send_param_tahfizh',{
                            params:{
                                    'data_show' : app.data_show,
                                    'data_tahfizh' :app.data_tahfizh,
                                    'tahfizh_type' : resp.data.tahfizh_type,
                                }
                            })
                        .then(function(resp){
            ...
            insert_tahfizh(e,student_id,tahfizh_type){
                axios.post('tahfizh',{
                    'tahfizh_value': e.target.value,
            ...
            get_value(student_id,tahfizh_type,tahfizh){
                var app =this;
                let input_tahfizh;
                const token = store.state.token
                 $.ajax({
                        url: '/api/get_value_tahfizh',
                        type:'GET',
                         headers:{
                        ...
                        success:function(resp){
                              return input_tahfizh = resp.data;
                        }
                    }).done(function(){
                        $('#loading_show').hide();
                    })
                 return input_tahfizh;
            },
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('tahfizh/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/tahfizh_upload',formData,
                    {
