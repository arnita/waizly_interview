        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Kelola Nilai Ulangan Daily Test Keterampilan </h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                        </li>
                        <li class="breadcrumb-item">Kelola Nilai Ulangan Daily Test Keterampilan
                        </li>    
                    </ol>
                </div>
            </div>
                            ...
                            <div class="col-sm-12 table-responsive">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="unit_id"  name="unit_id" v-model="daily_exercise_skill.unit_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="daily_exercise_skill.class_grade_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="study_group_id"   name="study_group_id" @change="get_course_($event)" v-model="daily_exercise_skill.study_group_id">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="course_id" name="course_id" v-model="daily_exercise_skill.course_id" @change="get_daily_exercise_skill($event)" >
        ...
        <div class="row" style="" v-if="div_seen" >
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h5 class="card-header-text"> Kelola Nilai Ulangan Daily Test Keterampilan  </h5>
                            <div class="m-t-2">
...
export default{
    ...
    created(){
        ...
        this.get_study_group_all(this.daily_exercise_skill.class_grade_id);  
        this.get_course_(this.daily_exercise_skill.study_group_id);  
    },
    computed:{
    ...
    methods:{
            ...
            $.ajax({
                ...
                data:{
                    ...
                    'structure_tematic_id': structure_tematic_id,
                            // 'course_id' :course,
                            'kd_type' : app.daily_exercise_skill.kd_type  
                        },
        ...
        daily_exercise_skill_student(event,dt_uh,kd_detail_id,student_id,structure_tematic_id){
            var course = $('#course_id').val();
            var kd_tp = $('#kd_type').val();
            if(course_id == '' || kd_tp == '' )
            {
            ...
            var app =this;
            axios.post('daily_exercise_skill',{
        ...
        get_data_page(page){
            ...
            axios.get('daily_exercise_skill?page='+page+'&study_group_id='+$('#study_group_id').val())
            .then(function(resp){
        ...
        exportTableToExcel(table, name=''){
            ...
            window.open('daily_exercise_skill/export?study_group_id='+study_group_id+'&course_id='+app.daily_exercise_skill.course_id+'&kd_type=Keterampilan&class_grade_id='+app.daily_exercise_skill.class_grade_id);
        ...
        saveUpload(){
            ...
            axios.post('/daily_exercise_skill_upload',formData,
            {
            ...
            .then(function(resp){
               ...
               axios.get('get_study_group_setting?study_group_id='+app.daily_exercise_skill.study_group_id)
               .then(function(resp){
               ...
               axios.get('get_total_daily_exercise_skill?course_id='+app.daily_exercise_skill.course_id+'&study_group_id='+app.daily_exercise_skill.study_group_id+'&kd_type='+'Keterampilan&class_grade_id='+app.daily_exercise_skill.class_grade_id)
               .then(function(resp){
                app.data_daily_exercise_skill = resp.data.data_daily_exercise_skill; 
                app.category = resp.data.category; 
                app.dt_k = resp.data.dt_k;


                axios.post('send_param_daily_exercise_skill',{
                    params:{
                        'data_show' : app.data_show,
                        'data_daily_exercise_skill' :app.data_daily_exercise_skill,
    ...
    //         console.log(this.study_group);       
    //         this.study_group_all = this.study_group;
    //     });                
    // },
     ...
     get_course_(e){
        ...
        {
            e = app.daily_exercise_skill.study_group_id;  
        }

        app.get_course_study_group(app.daily_exercise_skill.class_grade_id).then(()=>{      
        console.log(app.course_study_group)              
            app.list_course_ = app.course_study_group;
        });       
        app.get_daily_exercise_skill();
    ...
    // },
    get_daily_exercise_skill(e){                          

        $('#row_setting_pengetahuan').show();
