        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">Observasi
                    </li>        
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 table-responsive">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="observasi.unit_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="observasi.class_grade_id">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="observasi.study_group_id">
 ...
 <div class="row" style="display: none" id="row_setting">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        <h5 class="card-header-text"> Input Observasi</h5>
                        <div class="m-t-2">
...
import loading from '../../components/loading';
    ...
    export default{
        ...
        methods:{
            ...
            async get_data_setting(event){
                $('#loading_show').show();
                $('#row_setting').show();
                var app =this;

                await axios.get('get_study_group_setting?study_group_id='+app.observasi.study_group_id)
                    .then(function(resp){
                        app.data_show = resp.data;
                        app.data_post = resp.data;
                        app.loading=false;  

                        axios.get('get_total_observasi')
                            .then(function(resp){
                                app.data_observasi = resp.data.data_observasi; 
                                app.sosial = resp.data.sosial; 
                                app.spiritual = resp.data.spiritual; 
                                axios.post('send_param_observasi',{
                                    params:{
                                            'data_show' : app.data_show,
                                            'data_observasi' :app.data_observasi,
            ...
            insert_observasi(ab,student_id,observasi_type,observasi_category){

                axios.post('observasi',{
                    'observasi_value': ab,
            ...
            exportTableToExcel(table, name=''){
                var study_group_id = $('#study_group_id').val();
                var kd_id = $('#kd_id').val();
                window.open('observasi/export?study_group_id='+study_group_id);
            ...
            saveUpload(){
                ...
                axios.post('/observasi_upload',formData,
                    {
                ...
                .then(function(resp){
                     ...
                     axios.get('get_study_group_setting?study_group_id='+app.observasi.study_group_id)
                    .then(function(resp){
                        app.data_show = resp.data;
                        app.data_post = resp.data;
                        app.loading=false;  
