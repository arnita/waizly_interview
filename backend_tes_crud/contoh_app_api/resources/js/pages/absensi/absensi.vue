                            ...
                            <div class="col-sm-12 table-responsive">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="unit_id" @change="get_class_($event)" name="unit_id" v-model="absensi.unit_id">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="class_grade_id" @change="get_study_group_($event)" name="class_grade_id" v-model="absensi.class_grade_id">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="study_group_id" name="study_group_id" @change="get_data_setting($event)" v-model="absensi.study_group_id">
        ...
        <div class="row" style="display: none" id="row_setting">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h5 class="card-header-text"> Input Absen</h5>
                            <div class="m-t-2">
                                <button class="btn btn-primary" @click="exportTableToExcel()"> <i class="fa fa-download"></i> Download Format  </button>
                                <button class="btn btn-success" @click="uploadExcel()"> <i class="fa fa-upload"></i> Upload Absensi  </button>
                            </div>
                        </div>
...
export default{
    ...
    methods:{
        ...
        get_data_setting(event){
            ...
            $('#row_setting').show();
            var app = this;
            axios.get('get_study_group_setting?study_group_id='+app.absensi.study_group_id)
            .then(function(resp){
                app.data_show = resp.data;
                app.data_post = resp.data;
                app.loading=false;  

                axios.get('get_total_absensi')
                .then(function(resp){
                    app.data_absen = resp.data.data_absen; 
                    app.month = resp.data.month; 
                    axios.post('send_param_absensi',{
                        params:{
                            'data_show' : app.data_show,
                            'data_absen' :app.data_absen,
        ...
        insert_absensi(e,student_id,absensi_type,month){
            axios.post('absensi',{
                'absensi_total': e.target.value,
        ...
        exportTableToExcel(table, name=''){
            var study_group_id = $('#study_group_id').val();
            var kd_id = $('#kd_id').val();
            window.open('absensi/export?study_group_id='+study_group_id);
        ...
        saveUpload(){
            ...
            axios.post('/absensi_upload',formData,
            {
