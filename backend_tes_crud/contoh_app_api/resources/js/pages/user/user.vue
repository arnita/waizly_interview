                    ...
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <form id="form-menu" @submit="submit">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row" :class="{'has-danger':errors.menu_parent}">
                                        <label for="exampleInputEmail1" class="form-control-label"> Menu Induk </label>
                                        <select class="form-control" id="unit_id" name="unit_id" v-model="menu.menu_parent">
                                            <option value=""> - Pilih Menu - </option>
                                            <option value="0"> - Jadikan Menu Utama - </option>
                                            <option  v-for="(item, index) in menu_parent" :key="index" :value="item.menu_parent"> {{item.menu_parent}} </option>
                                        </select>
