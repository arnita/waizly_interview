    ...
    <div class="row">
        <div class="col-sm-12 p-0">
            <div class="main-header">
                <h4>Tambah Ruangan Kelas</h4>
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    
                    <li class="breadcrumb-item"> <router-link :to="{name:'home'}"><i class="icofont icofont-home"></i> Home  </router-link> 
                    </li>
                    <li class="breadcrumb-item"> <router-link to="/class_room">  Ruangan Kelas </router-link>
                    </li>
                    <li class="breadcrumb-item"> Tambah Ruangan Kelas
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Tambah Ruangan Kelas</h5>
                </div>
    ...
    export default{
        ...
        methods:{
            ...
            clear_form(){
                ...
                this.class_room.class_room_status='';
